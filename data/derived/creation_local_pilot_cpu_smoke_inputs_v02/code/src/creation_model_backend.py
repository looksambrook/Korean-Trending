"""Offline text proxy: identical frozen Qwen base, context arm, actual LoRA arm.
...
DEFAULTS = {
    "device": "cuda", "dtype": "float16", "steps": 2, "seed": 42,
...
def run_experiment(*, model_path, revision, cases, train_examples, output_dir,
                   settings=None, registered_run_id, identity=None):
    ...
    manifest = {"schema_version":"creation-model-backend-v1", "run_id":registered_run_id,
        "scope":"developer_local_text_proxy_pilot", "status":"started", "settings":options,
    ...
    try:
        ...
        write_json(destination/"adapter_config.json",{"base_revision":revision,"base_snapshot_sha256":manifest["model_identity"]["snapshot_sha256"],**manifest["lora"]})
